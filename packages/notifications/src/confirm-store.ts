import type { ConfirmationRequest, ConfirmationResult, ConfirmDeleteRequest } from './types';
 ...
 * another layer. Each client binds it to a renderer through
 * `useSyncExternalStore` (Radix dialog on web, a native Modal on mobile).
 */
class ConfirmStore {
