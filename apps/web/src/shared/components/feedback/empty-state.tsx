  ...
  return (
    <div className="reveal grid min-h-56 place-items-center rounded-[8px] border border-dashed border-[var(--border)] bg-[var(--surface-lowest)] p-8 text-center">
      <div className="grid max-w-md justify-items-center gap-3">
        <div className="animate-pop grid size-14 place-items-center rounded-full border border-[var(--border)] bg-[var(--surface-low)] text-[var(--accent-ink)] shadow-[0_0_40px_-16px_rgb(var(--accent-channels)/0.5)]">
