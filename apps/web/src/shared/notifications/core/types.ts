 ...
 *
 * These types are provider-agnostic: nothing here imports sonner, Radix or React.
 * Adapters (see ../adapters) translate them into a concrete visual surface.
 */
...
/** Sonner accepts a number of ms or Infinity for persistent toasts. */
 ...
 * as cancelling — callers can tell "clicked Cancel" from "pressed Escape".
 */
