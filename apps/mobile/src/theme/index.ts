 ...
 */
// `radii` no se reexporta: la escala compartida la fija la web y este archivo
// define la propia del móvil más abajo.
export { spacing, fontWeights, minTouchTarget } from '@gymsheet/design-tokens';
