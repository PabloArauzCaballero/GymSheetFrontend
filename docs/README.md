...
- `beta-readiness.md`: local beta startup, credentials, checks and recovery.
- `architecture/`: structure and dependency decisions.
...
- `ui/`: design system, traceability and user-provided visual references.
